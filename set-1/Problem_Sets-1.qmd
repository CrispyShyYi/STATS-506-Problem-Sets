...
For source files and data, see my GitHub repo: [STATS-506-Problem-Sets-01](https://github.com/CrispyShyYi/STATS-506-Problem-Sets/tree/main/set-1)
...
Rules: 1. Exclude ages under 18: minors unlikely to be primarily responsible for household food expenditures 2. Exclude ages greater than 100: likely mis-entries
...
Rules: 1. Keep only valid U.S. states and DC 2. Remove rows with NA or not matching states
...
Rules: 1. non-negative 2. total_food_exp should not be less than the sum of the components (grocery + dining out + misc) 3. Regarding NA as 0
...
Rules: 1. Must be an integer \>= 0 2. Exclude rows with unrealistic values (e.g. \> 21 times in a week \approx \>3/day).
